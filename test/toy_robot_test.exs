defmodule ToyRobotTest do
  use ExUnit.Case
  doctest ToyRobot.ToyRobot

  test "rotates the robot to the right" do
    {:ok, robot} = ToyRobot.ToyRobot.place(0, 0, :north)
    position = robot |> ToyRobot.ToyRobot.right() |> ToyRobot.ToyRobot.report()
    assert position == {0, 0, :east}

    position =
      robot
      |> ToyRobot.ToyRobot.right()
      |> ToyRobot.ToyRobot.right()
  ...
  test "rotates the robot to the left" do
    {:ok, robot} = ToyRobot.ToyRobot.place(0, 0, :north)
    position = robot |> ToyRobot.ToyRobot.left() |> ToyRobot.ToyRobot.report()
  ...
  test "rotating the robot 3 times to the right is the same as rotate its to the left" do
    ...
    left_position = robot |> ToyRobot.ToyRobot.left() |> ToyRobot.ToyRobot.report()
  ...
  test "moving robot up if it is facing to the north" do
    {:ok, robot} = ToyRobot.ToyRobot.place(0, 0, :north)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()

    assert position == {0, 1, :north}
  end

  test "moving robot right if it is facing to the east" do
    {:ok, robot} = ToyRobot.ToyRobot.place(0, 0, :east)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()
  ...
  test "moving robot down if it is facing to the south" do
    {:ok, robot} = ToyRobot.ToyRobot.place(4, 4, :south)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()
  ...
  test "moving robot left if it is facing to the west" do
    {:ok, robot} = ToyRobot.ToyRobot.place(4, 4, :west)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()
  ...
  test "prevent the robot to fall going north" do
    {:ok, robot} = ToyRobot.ToyRobot.place(4, 4, :north)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()
  ...
  test "prevent the robot to fall going east" do
    {:ok, robot} = ToyRobot.ToyRobot.place(4, 4, :east)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()
  ...
  test "prevent the robot to fall going south" do
    {:ok, robot} = ToyRobot.ToyRobot.place(0, 0, :south)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()
  ...
  test "prevent the robot to fall going west" do
    {:ok, robot} = ToyRobot.ToyRobot.place(0, 0, :west)
    position = robot |> ToyRobot.ToyRobot.move() |> ToyRobot.ToyRobot.report()
